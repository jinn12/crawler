...
import com.kiprisplus.api.trademark.model.vo.advancedSearch.AdSearchResponseBodyVO;


@XmlRootElement(name = "response")
@XmlAccessorType(XmlAccessType.FIELD)
public class TrademarkAdvancedSearchResponsVO extends KipirsPlusReponse {
