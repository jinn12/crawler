...
import com.kiprisplus.api.patent.model.vo.bibliographyDetailInfoSearch.BiblioDetailSearchResponseBodyVO;

@XmlRootElement(name = "response")
@XmlAccessorType(XmlAccessType.FIELD)
public class PatentBibliographyDetailInfoSearchResponseVO {
